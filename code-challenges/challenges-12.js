...
const cvsFiltration = (arr) => {
   let result = arr.filter(x => x.yearsOfExperience>=4 && x.tech =="JS" && x.firstName !=null && x.LastName !=null);
  
  const final = result.map(y => {
  return {
...
const skillComparison = (arr1, arr2) => {
    let result = arr1.filter(x => !arr2.includes(x)).concat(arr2.filter(x => !arr1.includes(x)));
return result;
}
// -------------------------------------------------------------------------------------------------------
